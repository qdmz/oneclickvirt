...
type User struct {
	...
	EmailVerified    bool     `json:"emailVerified" gorm:"default:false;comment:email verified"`
	RealNameVerified bool     `json:"realNameVerified" gorm:"default:false;comment:real name verified"`
