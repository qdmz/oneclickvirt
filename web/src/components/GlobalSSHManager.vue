      ...
      >
        ...
        <div class="ssh-dialog-content">
          <SSHTerminal
            ...
            :is-provider="conn.isProvider || false"
...
const allConnections = computed(() => {
  const connections = Object.entries(sshStore.connections).map(([instanceId, conn]) => ({
    instanceId,
    ...conn
  }))
  console.log('GlobalSSHManager allConnections:', connections)
  return connections
})
