<template>
  <el-form
    ...
    class="server-form"
  >
    <!-- ZJMF API Authentication -->
    <template v-if="modelValue.type === 'zjmf'">
      <el-form-item
        label="API Key"
        prop="apiKey"
      >
      ...
      >
        <el-input
          v-model="modelValue.apiSecret"
          type="password"
          placeholder="请输入智简魔方 API Secret"
          show-password
        />
      </el-form-item>
      ...
      >
        <el-input
          ...
          placeholder="请输入智简魔方 API URL (可选)"
        />
        <div class="form-tip">
          <el-text
            size="small"
    ...
    <!-- SSH Authentication (for non-ZJMF providers) -->
    <template v-else>
      <el-form-item
