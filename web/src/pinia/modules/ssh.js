...
export const useSSHStore = defineStore('ssh', {
  ...
  actions: {
    // 创建SSH连接
  createConnection(instanceId, instanceName, isAdmin = false, isProvider = false) {
    console.log('sshStore.createConnection called:', {
      instanceId,
      instanceName,
      isAdmin,
      isProvider
    ...
    console.log('sshStore.connections after create:', this.connections)
  },
